...
car.accelerate(30)
assert car.current_speed_km_per_h == 30
car.accelerate(70)
assert car.current_speed_km_per_h == 100
car.accelerate(50)
assert car.current_speed_km_per_h == car.maximum_speed_km_per_h
car.accelerate(-200)
assert car.current_speed_km_per_h == 0
